...
describe DesignationsController do
  ...
  # DesignationsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET show" do
    it "assigns the requested designation as @designation" do
      designation = Designation.create! valid_attributes
      get :show, {:id => designation.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested designation as @designation" do
      designation = Designation.create! valid_attributes
      get :edit, {:id => designation.to_param}, valid_session
      assigns(:designation).should eq(designation)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Designation" do
        expect {
          post :create, {:designation => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved designation as @designation" do
        ...
        post :create, {:designation => {}}, valid_session
        assigns(:designation).should be_a_new(Designation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested designation" do
        ...
        put :update, {:id => designation.to_param, :designation => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested designation as @designation" do
        designation = Designation.create! valid_attributes
        put :update, {:id => designation.to_param, :designation => valid_attributes}, valid_session
        assigns(:designation).should eq(designation)
      end
    ...
    describe "with invalid params" do
      it "assigns the designation as @designation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Designation.any_instance.stub(:save).and_return(false)
        put :update, {:id => designation.to_param, :designation => {}}, valid_session
        assigns(:designation).should eq(designation)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested designation" do
      designation = Designation.create! valid_attributes
      expect {
        delete :destroy, {:id => designation.to_param}, valid_session
      }.to change(Designation, :count).by(-1)
    end
